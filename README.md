...
* Calculate Rarity score of NFT
* Generate File Generated Summary report after finish
* Can modify the start ID of NFT
...
* Image URL: Enter the base url of your images. Leave it empty if you dont have.
  Example: If you enter https://google.com/api/toantran/, the script will output https://google.com/api/toantran/ID
